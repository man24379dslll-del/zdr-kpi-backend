...
Сама формула ЗП и двухэтапная ведомость — отдельный следующий шаг
переноса, здесь не реализованы.
"""
from __future__ import annotations

TIER_COEFFICIENTS = [1.4, 1.3, 1.2, 1.1, 1.05, 1, 0.9, 0.75, 0.5, 0.25]
MONTHLY_BASE_RATE = 20000  # делится на 4 или 5 (недель в месяце)
