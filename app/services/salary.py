...
сторона, см. routers/ratings.py — там же объяснено, почему поиск
предыдущей недели работает только внутри того же месяца). Если прошлой
недели нет, или человека там не было — коэффициент = 1.0.
