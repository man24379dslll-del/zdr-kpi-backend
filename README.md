...
- `app/services/salary.py` — **ЗП недели**: ставка_за_час
  (`monthly_base_rate / hours_norm`, по умолчанию 40000/160, обе
  настраиваемые) × "Рабочее время, ч" сотрудника за неделю (из файла,
  см. `excel_parsing.WORK_HOURS_COLUMN`) + бонус075 + бонус2, всё × на
  коэффициент ЛГ ПРОШЛОЙ недели. Полностью заменяет старую формулу
